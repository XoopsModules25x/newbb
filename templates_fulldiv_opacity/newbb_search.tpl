...
<form name="Search" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/search.php" method="get">
    <div class="outer">
        ...
        <div class="clear"></div>
        <div class="head search_col floatleft right" id="align_right"
             title="<{$smarty.const._MD_SELECT_STARTLAG_DESC}>"><strong><{$smarty.const._MD_SELECT_STARTLAG}></strong>&nbsp;
        </div>
        <div class="even _col_end" title="<{$smarty.const._MD_SELECT_STARTLAG_DESC}>"><input type="text"
                                                                                             name="selectstartlag"
                                                                                             value="<{$selectstartlag_select}>"/>
        </div>
        <div class="clear"></div>
        <div class="head search_col floatleft right" id="align_right">
            <strong><{$smarty.const._MD_SELECT_LENGTH}></strong>&nbsp;</div>
        <div class="even _col_end"><input type="text" name="selectlength" value="<{$selectlength_select}>"/></div>
        <div class="clear"></div>
        <div class="head search_col floatleft right" id="align_right"><strong><{$smarty.const._MD_SELECT_HTML}></strong>&nbsp;
        </div>
        <div class="even _col_end"><{$selecthtml_radio}></div>
        <div class="clear"></div>
        <div class="head search_col floatleft right" id="align_right">
            <strong><{$smarty.const._MD_SELECT_EXCLUDE}></strong>&nbsp;</div>
