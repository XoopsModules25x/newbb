...
<div class="thread_title_bar <{if $topic_post.post_no == 1}>thread_title_bar_top<{/if}> outer" id="<{$forum_post_prefix}><{$topic_post.post_id}>">
    ...
    <div class="thread_date floatleft right comDate"><span class="thread_date_caption comDateCaption"><{$smarty.const._MD_POSTEDON}></span><{$topic_post.post_date}></div>
    ...
    <div class="thread_userinfo odd forum_cell">
        <{if $topic_post.poster.uid gt 0}>
            ...
            <div class="thread_poster_rank comUserRankText"><{if $topic_post.poster.rank.title !=""}> <{$topic_post.poster.rank.title}>
                    <br>
                    <imgsrc="<{$xoops_upload_url}>/<{$topic_post.poster.rank.image}>" alt="<{$topic_post.poster.rank.title}>" /><{/if}></div>
            ...
            <{if $infobox.show}>
                ...
                <div id="toggle-<{$topic_post.post_id}>" class="toggle_<{$infobox.style}>">
                    <div class="thread_poster_stat comUserStat"><span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._MD_JOINED}>:</span><br><{$topic_post.poster.regdate}>
                        <br><span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._US_LASTLOGIN}>:</span><br><{$topic_post.poster.last_login}></div>
                    ...
                    <div class="thread_poster_stat comUserStat">
                        ...
                        <{if $topic_post.poster.digests gt 0}>
                            |
                            <span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._MD_DIGESTS}>:</span>
