            ...
            <{if $topic_post.poster.uid gt 0}>
                ...
                <{if $infobox.show}>
                    ...
                    <div id="toggle-<{$topic_post.post_id}>" class="toggle_<{$infobox.style}>">
                        <div class="thread_poster_stat comUserStat"><span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._MD_NEWBB_JOINED}>:</span><br><{$topic_post.poster.regdate}><br><span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._US_LASTLOGIN}>:</span><br><{$topic_post.poster.last_login}></div>
                        ...
                        <div class="thread_poster_stat comUserStat">
                            ...
                            <{if $topic_post.poster.digests gt 0}>
                                | <span class="thread_poster_stat_caption comUserStatCaption"><{$smarty.const._MD_NEWBB_DIGESTS}>:</span> <{$topic_post.poster.digests}>
                            <{/if}>
                        </div>
