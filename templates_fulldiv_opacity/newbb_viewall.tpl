...
<{elseif $menumode eq 1}>
    <div id="topicoption" class="menu">
        <a class="item floatleft" href="<{$post_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_ALLPOSTS}></a>
        <a class="item floatleft" href="<{$newpost_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_NEWPOSTS}></a>
        <a class="item floatleft" href="<{$all_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_ALL}></a>
        <a class="item floatleft" href="<{$digest_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_DIGEST}></a>
        <a class="item floatleft" href="<{$unreplied_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_UNREPLIED}></a>
        <a class="item _col_end" href="<{$unread_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_UNREAD}></a>
        <div class="clear"></div>
    </div>
    ...
    <div class="menu">
        <ul>
            <li>
                ...
                <ul>
                    <li>
                        <div class="item floatleft"><a href="<{$post_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_ALLPOSTS}></a></div>
                        <div class="item floatleft"><a href="<{$newpost_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_NEWPOSTS}></a></div>
                        <div class="item floatleft"><a href="<{$all_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_ALL}></a></div>
                        <div class="item floatleft"><a href="<{$digest_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_DIGEST}></a></div>
                        <div class="item floatleft"><a href="<{$unreplied_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_UNREPLIED}></a></div>
                        <div class="item _col_end"><a href="<{$unread_link}>"><{$smarty.const._MD_VIEW}>&nbsp;<{$smarty.const._MD_UNREAD}></a></div>
                        <div class="clear"></div>
                    </li>
                </ul>
            </li>
...
<div class="topic_list outer">
    ...
    <div class="<{cycle values="even,odd"}>">
        ...
        <div class="topic_icon floatleft align_center">
            ...
            <{else}>
                <{$topic.topic_icon}><{$topic.sticky}><br><{$topic.digest}><{$topic.poll}>
            <{/if}>
        </div>
