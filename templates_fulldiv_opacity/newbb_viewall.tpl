...
<form name="form_topics_admin" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/action.topic.php" method="POST"
    ...
    <div class="dropdown">
        ...
        <{elseif $menumode eq 1}>
            <div id="topicoption" class="menu">
                <a class="item floatleft" href="<{$post_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_ALLPOSTS}></a>
                <a class="item floatleft" href="<{$newpost_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_NEWPOSTS}></a>
                <a class="item floatleft" href="<{$all_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_ALL}></a>
                <a class="item floatleft" href="<{$digest_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_DIGEST}></a>
                <a class="item floatleft" href="<{$unreplied_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_UNREPLIED}></a>
                <a class="item _col_end" href="<{$unread_link}>"><{$smarty.const._MD_VIEW}>
                    &nbsp;<{$smarty.const._MD_UNREAD}></a>
                <div class="clear"></div>
            </div>
            <script type="text/javascript">document.getElementById("topicoption").onmouseout = closeMenu;</script>
            <div class="menubar"><a href=""
                                    onclick="openMenu(event, 'topicoption');return false;"><{$smarty.const._MD_TOPICOPTION|escape:'quotes'}></a>
            </div>
            ...
            <div class="menu">
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <div class="item floatleft"><a href="<{$post_link}>"><{$smarty.const._MD_VIEW}>
                                        &nbsp;<{$smarty.const._MD_ALLPOSTS}></a></div>
                                <div class="item floatleft"><a href="<{$newpost_link}>"><{$smarty.const._MD_VIEW}>
                                        &nbsp;<{$smarty.const._MD_NEWPOSTS}></a></div>
                                <div class="item floatleft"><a href="<{$all_link}>"><{$smarty.const._MD_VIEW}>
                                        &nbsp;<{$smarty.const._MD_ALL}></a></div>
                                <div class="item floatleft"><a href="<{$digest_link}>"><{$smarty.const._MD_VIEW}>
                                        &nbsp;<{$smarty.const._MD_DIGEST}></a></div>
                                <div class="item floatleft"><a href="<{$unreplied_link}>"><{$smarty.const._MD_VIEW}>
                                        &nbsp;<{$smarty.const._MD_UNREPLIED}></a></div>
                                <div class="item _col_end"><a href="<{$unread_link}>"><{$smarty.const._MD_VIEW}>
    ...
    <div class="topic_list outer">
        <div class="head align_center">
            ...
            <div class="topic_name floatleft">&nbsp;<strong><a
                            href="<{$headers.topic.link}>"><{$headers.topic.title}></a></strong></div>
            <div class="topic_forumname floatleft"><strong><a
                            href="<{$headers.forum.link}>"><{$headers.forum.title}></a></strong></div>
            <div class="topic_reply floatleft"><strong><a
                            href="<{$headers.replies.link}>"><{$headers.replies.title}></a></strong></div>
            <div class="topic_poster floatleft"><strong><a href="<{$headers.poster.link}>"><{$headers.poster.title}></a></strong>
            </div>
            <div class="topic_view floatleft"><strong><a
                            href="<{$headers.views.link}>"><{$headers.views.title}></a></strong></div>
            <div class="_col_end"><strong><a href="<{$headers.lastpost.link}>"><{$headers.lastpost.title}></a></strong>
            </div>
            <div class="clear"></div>
        </div>
        <!-- start forum topic -->
