<div>
    ...
    <div class="odd" style="padding: 5px; line-height: 150%;">
        [ <span class="online_admin"><{$smarty.const._MD_NEWBB_ADMINISTRATOR}></span> ] [ <span class="online_moderator"><{$smarty.const._MD_NEWBB_MODERATOR}></span> ]
        <br><{$online.num_anonymous}> <{$smarty.const._MD_NEWBB_ANONYMOUS_USERS}>
        <{if $online.num_user}>
            <br><{$online.num_user}> <{$smarty.const._MD_NEWBB_REGISTERED_USERS}>
