...
// 4.2
define('_MD_ADVERTISING_BLOCK', '<br />Here you could place your Ad!<br />Please contact us to learn more about it.');
...
define('_MD_CAN_PDF', 'You <strong>can</strong> create PDF files.<br />');
define('_MD_CANNOT_PDF', 'You <strong>cannot</strong> create PDF files.<br />');
