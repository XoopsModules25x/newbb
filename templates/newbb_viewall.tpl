    ...
    <table class="outer" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
        ...
        <tr class="head" class="align_left">
            ...
            <td width="15%" align="center" nowrap="nowrap"><strong><a
                            href="<{$headers.forum.link}>"><{$headers.forum.title}></a></strong></td>
            <td width="5%" align="center" nowrap="nowrap"><strong><a
                            href="<{$headers.replies.link}>"><{$headers.replies.title}></a></strong></td>
            <td width="10%" align="center" nowrap="nowrap"><strong><a
                            href="<{$headers.poster.link}>"><{$headers.poster.title}></a></strong></td>
            <td width="5%" align="center" nowrap="nowrap"><strong><a
                            href="<{$headers.views.link}>"><{$headers.views.title}></a></strong></td>
            <td width="15%" align="center" nowrap="nowrap"><strong><a
                            href="<{$headers.lastpost.link}>"><{$headers.lastpost.title}></a></strong></td>
        </tr>
        ...
        <tr class="<{cycle values="even,odd"}>">
            ...
            <td width="4%" align="center"><{$topic.topic_icon}><{$topic.sticky}><br><{$topic.digest}><{$topic.poll}>
            </td>
            <!-- irmtfan remove topic_link hardcode and add topic_excerpt -->
            <td>&nbsp;<a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/<{$topic.topic_link}>"
