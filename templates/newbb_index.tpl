        ...
        <tr class="head">
            ...
            <{if $category.cat_sponsor}>
                ...
                <td width="15%" nowrap="nowrap" class="align_right">
                    <p class="desc"><a href="<{$category.cat_sponsor.link}>" title="<{$category.cat_sponsor.title}>"
                                       target="_blank"><{$category.cat_sponsor.title}></a></p>
                </td>
            <{/if}>
        </tr>
    </table>
            ...
            <{if $category.forums}>
                <tr class="head" align="center">
                    ...
                    <{if $subforum_display == "expand"}>
                        <!-- irmtfan hardcode removed align="left" -->
                        <td colspan="2" width="37%" nowrap="nowrap" class="align_left"><{$smarty.const._MD_FORUM}></td>
                    <{else}>
                        <!-- irmtfan hardcode removed align="left" -->
                        <td width="37%" nowrap="nowrap" class="align_left"><{$smarty.const._MD_FORUM}></td>
                    <{/if}>
                    <td width="9%" nowrap="nowrap"><{$smarty.const._MD_TOPICS}></td>
                    <td width="9%" nowrap="nowrap"><{$smarty.const._MD_POSTS}></td>
                    <td width="40%" nowrap="nowrap"><{$smarty.const._MD_LASTPOST}></td>
                </tr>
            <{/if}>
            ...
            <{if $subforum_display == "expand"}>
                ...
                <tr>
                    ...
                    <td width="5%" class="even <{if $forum.forum_read eq 1 }>forum-read<{else}>forum-new<{/if}>"
                        align="center" valign="middle"><{$forum.forum_folder}></td>
...
<{$smarty.const._MD_MODERATOR}>: <{$forum.forum_moderators}>
                ...
                <{if $forum.subforum}>
                    <tr class="head">
                        ...
                        <td width="32%" align="center"><{$smarty.const._MD_SUBFORUMS}>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <!-- irmtfan add forum-read/forum-new smarty variable  -->
                        <td class="even <{if $subforum.forum_read eq 1 }>forum-read<{else}>forum-new<{/if}>"
                            align="center" valign="middle" width="5%"><{$subforum.forum_folder}></td>
...
<{$smarty.const._MD_MODERATOR}>: <{$subforum.forum_moderators}>
            ...
            <{elseif $subforum_display == "collapse"}>
                ...
                <tr>
                    <{if $forum.subforum}>
                        <!-- irmtfan add forum-read/forum-new smarty variable  -->
                        <td class="even <{if $forum.forum_read eq 1 }>forum-read<{else}>forum-new<{/if}>" rowspan="2"
                            align="center" valign="middle"><{$forum.forum_folder}></td>
                    <{else}>
                        <td class="even <{if $forum.forum_read eq 1 }>forum-read<{else}>forum-new<{/if}>" align="center"
                            valign="middle"><{$forum.forum_folder}></td>
                    <{/if}>
                    <td class="odd">
                        <div id="index_forum">
<span class="item"><a
