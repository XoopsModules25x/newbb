<?php
// $Id: viewpost.php 12504 2014-04-26 01:01:06Z beckmi $
//  ------------------------------------------------------------------------ //
...
$status = (!empty($_GET['status']) && in_array($_GET['status'], array("active", "pending", "deleted", "new", "all", "digest"))) ? $_GET['status'] : "";
