...
<div class="outer">
	...
	<div class="clear"></div>
    <div class="head search_col floatleft right"><strong><{$smarty.const._MD_FORUMC}></strong>&nbsp;</div>
	...
	<div class="clear"></div>
    <div class="head search_col floatleft right"><strong><{$smarty.const._MD_AUTHOR}></strong>&nbsp;</div>
    <div class="even _col_end"><input type="text" name="uname" value="<{$author_select}>" /></div>
	<div class="clear"></div>
	<div class="head search_col floatleft right"><strong><{$smarty.const._MD_SORTBY}></strong>&nbsp;</div>
    <div class="even _col_end"><{$sortby_selection_box}></div>
	<div class="clear"></div>
	<div class="head search_col floatleft right"><strong><{$smarty.const._MD_SINCE}></strong>&nbsp;</div>
    <div class="even _col_end"><{$since_selection_box}></div>
	<div class="clear"></div>
    <div class="head search_col floatleft right" id="align_right" title="<{$smarty.const._MD_SELECT_STARTLAG_DESC}>"><strong><{$smarty.const._MD_SELECT_STARTLAG}></strong>&nbsp;</div>
    <div class="even _col_end" title="<{$smarty.const._MD_SELECT_STARTLAG_DESC}>"><input type="text" name="selectstartlag" value="<{$selectstartlag_select}>" /></div>
	<div class="clear"></div>
    <div class="head search_col floatleft right" id="align_right"><strong><{$smarty.const._MD_SELECT_LENGTH}></strong>&nbsp;</div>
    <div class="even _col_end"><input type="text" name="selectlength" value="<{$selectlength_select}>" /></div>
	<div class="clear"></div>
    <div class="head search_col floatleft right" id="align_right"><strong><{$smarty.const._MD_SELECT_HTML}></strong>&nbsp;</div>
    <div class="even _col_end"><{$selecthtml_radio}></div>
	<div class="clear"></div>
    <div class="head search_col floatleft right" id="align_right"><strong><{$smarty.const._MD_SELECT_EXCLUDE}></strong>&nbsp;</div>
    <div class="even _col_end"><{$selectexclude_check_box}></div>
	<div class="clear"></div>
	<div class="head search_col floatleft right"><strong><{$smarty.const._MD_SHOWSEARCH}></strong>&nbsp;</div>
    ...
    <div class="even _col_end"><input type="submit" value="<{$smarty.const._MD_SEARCH}>" /></div>
	<div class="clear"></div>
</div>
</form>
