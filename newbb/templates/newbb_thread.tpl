...
<!-- irmtfan hardcode removed align="left" -->
        <th width="75%" class="left"><div class="comTitle"><{$topic_post.post_title}></div></th>
...
<!-- irmtfan remove icon_path -->
				...
				<{if $infobox.show}>
					...
					<div id="<{$topic_post.post_id}>" style="display: <{$infobox.style}>;" >
                    	<div class="comUserStat"><span class="comUserStatCaption"><{$smarty.const._MD_JOINED}>:</span><br /><{$topic_post.poster.regdate}><br /><span class="comUserStatCaption"><{$smarty.const._US_LASTLOGIN}>:</span><br /><{$topic_post.poster.last_login}></div> <!-- irmtfan add last_login -->
