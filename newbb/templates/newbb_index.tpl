...
<{$smarty.const._MD_MODERATOR}>: <{$forum.forum_moderators}>
                ...
                <{if $forum.subforum}>
                    <tr>
                        ...
                        <td class="odd" colspan="4" class="align_left"><{$smarty.const._MD_SUBFORUMS}>&nbsp;<{$img_subforum}>&nbsp;
                            <{foreachq item=subforum from=$forum.subforum}>
...
<div class="icon_right">
    ...
    <{if $rss_button}>
        ...
        <br/>
        <span style='font-size: 0.7em;'><a href="http://www.simple-xoops.de">NewBB Version  <{$version/100}></a></span>
        <br/>
    <{/if}>
</div>
<br style="clear: both;"/>
