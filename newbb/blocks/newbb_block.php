<?php
// $Id: newbb_block.php 12504 2014-04-26 01:01:06Z beckmi $
//  ------------------------------------------------------------------------ //
...
function b_newbb_show($options)
{
    ...
    if (!empty($newbbConfig['do_rewrite'])) {
        include_once XOOPS_ROOT_PATH."/modules/newbb/seo_url.php";
    } else {
...
include_once XOOPS_ROOT_PATH . "/modules/newbb/footer.php";
